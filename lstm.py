...
#https://github.com/hualiu01/LSTMRNNStockr
...
plt.title('Scaled TESLA stocks from August 2015 to August 2018')
plt.xlabel('Days')
...
test_results = []
for i in range(len(data_to_use) - batch_size):
    if i > test_index:
